...
void DebugBox(Matrix const &transform, Vec4f const &min, Vec4f const &max, Color color);
void DebugSphere(Matrix const &transform, float radius, Color color, int segments = 1, int smoothness = 16);
